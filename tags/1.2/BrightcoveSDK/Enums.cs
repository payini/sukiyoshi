...
namespace BrightcoveSDK
{
	...
	public enum ControllerType { AKAMAI_STREAMING, AKAMAI_SECURE_STREAMING, AKAMAI_LIVE, AKAMAI_HD, AKAMAI_HD_LIVE, LIMELIGHT_LIVE, LIMELIGHT_MEDIAVAULT, UNDEFINED }
